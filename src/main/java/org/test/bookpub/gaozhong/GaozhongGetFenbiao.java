...
public class GaozhongGetFenbiao {
...
//                temp.add(t[0].replace("：", "").replace("，", "").replace(",", ""));
                ...
                if (t[1].startsWith("10月") || t[1].startsWith("8月")) {
...
//                items.get(index++).add(String.valueOf(suoyin));
            ...
            writeExcel("E:\\瞄之政治\\资料ALL\\20170729备份\\教研\\20171002-20171008\\gaozhongfenbiao.xls", items);
