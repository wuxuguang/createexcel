...
public class ChuZhongGetExcelInfo {
...
//                temp.add(t[0].replace("：", "").replace("，", "").replace(",", ""));
                ...
                if (t[1].startsWith("10月") || t[1].startsWith("9月")) {
...
/*                temp.add(lines.get(5 * j));
                String u = lines.get(5 * j + 1);
                if (!u.startsWith("7月"))
                    u = "7月" + u;
                temp.add(u.substring(0, 5));
                temp.add(u.substring(5));
                temp.add(lines.get(5 * j + 2));
                temp.add(lines.get(5 * j + 3));
                temp.add(lines.get(5 * j + 4));*/
                items.add(temp);
            }
            int count = 0;
            ...
            while (index < items.size()) {
                String sub = subjects.get(q);
                items.get(index).add("20171002-20171008");
            ...
            writeExcel("E:\\瞄之政治\\资料ALL\\20170729备份\\教研\\20171002-20171008\\chuzhong.xls", items);
